% focus-detector-qt(SECTION) | User Commands
%
% "June 27 2025"
...
focus-detector-qt - program to do something

# SYNOPSIS

**focus-detector-qt** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**focus-detector-qt** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **focus-detector-qt** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**focus-detector-qt** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    focus-detector-qt. See **foo.conf**(5) for further details.
...
**focus-detector-qt** provides some return codes, that can be used in scripts:
...
rewine <rewine@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 rewine
